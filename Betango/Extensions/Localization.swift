...
enum L10n {
    ...
    enum feature1 {
        ...
        static let date = LocalizedStringKey("feature1.date")
        static let time = LocalizedStringKey("feature1.time")
        static let name = LocalizedStringKey("feature1.name")
        static let namePlaceholder = LocalizedStringKey("feature1.name.placeholder")
