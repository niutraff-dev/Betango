...
- `PROJECT` - Path to .xcodeproj (Betango.xcodeproj)
- `SCHEME` - Xcode scheme name (Betango)
- `TEAM_ID` - Apple Developer Team ID (GZ8AQ5P2F7)
- `BUNDLE_ID` - Bundle Identifier (app.betango.com)
